...
function Categories() {
  return (
    <div className="container">
        <div className={`${styles.categories} ${styles.border}`}>
            <div className={styles.container}>
                <div className={styles.category}>
                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg"  loading="lazy" >
                        <g clip-path="url(#clip0_5151_868)">
            ...
            <div className={styles.container}>
                <div className={styles.category}>
                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg"  loading="lazy" >
                        <g clip-path="url(#clip0_5151_613)">
            ...
            <div className={styles.container}>
                <div className={styles.category}>
                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg"  loading="lazy">
                        <g clip-path="url(#clip0_5151_629)">
            ...
            <div className={styles.container}>
                <div className={styles.category}>
                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg"  loading="lazy">
                        <g clip-path="url(#clip0_5151_644)">
            ...
            <div className={styles.container}>
                <div className={styles.category}>
                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" loading="lazy" >
                        <g clip-path="url(#clip0_5151_809)">
